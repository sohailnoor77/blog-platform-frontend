...
const handleSubmit = async () => {
    ...
    try {
        await api.post('/author/blog/store', formData)
    ...
    <div class="bg-white py-10 sm:py-16">
        <div class="mx-auto max-w-7xl">
            <div class="flex items-center justify-between">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Create Blog</h1>
            </div>
            ...
            <div
                ...
                <form @submit.prevent="handleSubmit" class="col-span-2">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2">
                            <input type="text" name="title" id="title" required="" v-model="form.title"
                    ...
                    <div class="col-span-full mb-4">
                        ...
                        <div class="mt-2">
                            <textarea name="excerpt" id="excerpt" rows="3" v-model="form.excerpt"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                    ...
                    <div class="col-span-full mb-4">
                        ...
                        <div class="mt-2">
                            <textarea name="description" id="description" rows="6" v-model="form.description"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                    ...
                    <div class="mb-4">
                        <label for="title" class="block text-sm/6 font-medium text-gray-900">Keywords (should be comma
                            separated)</label>
                        <div class="mt-2">
                            <input type="text" name="title" id="title" required="" v-model="form.keywords"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2">
                            <input type="text" name="title" id="title" required="" v-model="form.meta_title"
                    ...
                    <div class="col-span-full mb-4">
                        <label for="description" class="block text-sm/6 font-medium text-gray-900">Meta
                            Description</label>
                        <div class="mt-2">
                            <textarea name="description" id="description" rows="3" v-model="form.meta_description"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                    ...
                    <div class="col-span-full mb-4">
                        ...
                        <img v-if="imagePreviewUrl" :src="imagePreviewUrl"
                            class="w-3/4 h-64 object-cover my-2 rounded-md" />
                    ...
                    <div class="mb-4">
                        <label for="title" class="block text-sm/6 font-medium text-gray-900">Publishing Scheduled
                            Date</label>
                        <div class="mt-2">
                            <input type="datetime-local" name="title" id="title" v-model="form.scheduled_at"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
